# agents.md — drasi-bootstrap-postgres-python

## Overview
This crate wraps `drasi-bootstrap-postgres` (at `../../../components/bootstrappers/postgres`) as a PyO3 Python module (`drasi_bootstrap_postgres`).

## Wrapped Rust Crate
- **Crate**: `drasi-bootstrap-postgres`
- **Path**: `../../../components/bootstrappers/postgres`
- **Cargo dependency key**: `drasi-bootstrap-postgres`
