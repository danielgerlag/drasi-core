# agents.md — drasi-bootstrap-application-python

## Overview
This crate wraps `drasi-bootstrap-application` (at `../../../components/bootstrappers/application`) as a PyO3 Python module (`drasi_bootstrap_application`).

## Wrapped Rust Crate
- **Crate**: `drasi-bootstrap-application`
- **Path**: `../../../components/bootstrappers/application`
- **Cargo dependency key**: `drasi-bootstrap-application`
