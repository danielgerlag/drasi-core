# agents.md — drasi-bootstrap-noop-python

## Overview
This crate wraps `drasi-bootstrap-noop` (at `../../../components/bootstrappers/noop`) as a PyO3 Python module (`drasi_bootstrap_noop`).

## Wrapped Rust Crate
- **Crate**: `drasi-bootstrap-noop`
- **Path**: `../../../components/bootstrappers/noop`
- **Cargo dependency key**: `drasi-bootstrap-noop`
