# agents.md — drasi-state-store-redb-python

## Overview
This crate wraps `drasi-state-store-redb` (at `../../../components/state_stores/redb`) as a PyO3 Python module (`drasi_state_store_redb`).

## Wrapped Rust Crate
- **Crate**: `drasi-state-store-redb`
- **Path**: `../../../components/state_stores/redb`
- **Cargo dependency key**: `drasi-state-store-redb`
