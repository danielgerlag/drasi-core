# agents.md — drasi-source-http-python

## Overview
This crate wraps `drasi-source-http` (at `../../../components/sources/http`) as a PyO3 Python module (`drasi_source_http`).

## Wrapped Rust Crate
- **Crate**: `drasi-source-http`
- **Path**: `../../../components/sources/http`
- **Cargo dependency key**: `drasi-source-http`
