# agents.md — drasi-source-grpc-python

## Overview
This crate wraps `drasi-source-grpc` (at `../../../components/sources/grpc`) as a PyO3 Python module (`drasi_source_grpc`).

## Wrapped Rust Crate
- **Crate**: `drasi-source-grpc`
- **Path**: `../../../components/sources/grpc`
- **Cargo dependency key**: `drasi-source-grpc`
