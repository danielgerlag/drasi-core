# agents.md — drasi-source-mock-python

## Overview
This crate wraps `drasi-source-mock` (at `../../../components/sources/mock`) as a PyO3 Python module (`drasi_source_mock`).

## Wrapped Rust Crate
- **Crate**: `drasi-source-mock`
- **Path**: `../../../components/sources/mock`
- **Cargo dependency key**: `drasi-source-mock`
