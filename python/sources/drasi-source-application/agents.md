# agents.md — drasi-source-application-python

## Overview
This crate wraps `drasi-source-application` (at `../../../components/sources/application`) as a PyO3 Python module (`drasi_source_application`).

## Wrapped Rust Crate
- **Crate**: `drasi-source-application`
- **Path**: `../../../components/sources/application`
- **Cargo dependency key**: `drasi-source-application`
