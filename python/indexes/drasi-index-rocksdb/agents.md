# agents.md — drasi-index-rocksdb-python

## Overview
This crate wraps `drasi-index-rocksdb` (at `../../../components/indexes/rocksdb`) as a PyO3 Python module (`drasi_index_rocksdb`).

## Wrapped Rust Crate
- **Crate**: `drasi-index-rocksdb`
- **Path**: `../../../components/indexes/rocksdb`
- **Cargo dependency key**: `drasi-index-rocksdb`
