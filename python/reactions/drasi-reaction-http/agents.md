# agents.md — drasi-reaction-http-python

## Overview
This crate wraps `drasi-reaction-http-adaptive` (at `../../../components/reactions/http-adaptive`) as a PyO3 Python module (`drasi_reaction_http`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-http-adaptive`
- **Path**: `../../../components/reactions/http-adaptive`
- **Cargo dependency key**: `drasi-reaction-http-adaptive`
