# agents.md — drasi-reaction-grpc-python

## Overview
This crate wraps `drasi-reaction-grpc-adaptive` (at `../../../components/reactions/grpc-adaptive`) as a PyO3 Python module (`drasi_reaction_grpc`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-grpc-adaptive`
- **Path**: `../../../components/reactions/grpc-adaptive`
- **Cargo dependency key**: `drasi-reaction-grpc-adaptive`
