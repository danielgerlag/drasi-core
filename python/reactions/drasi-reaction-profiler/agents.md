# agents.md — drasi-reaction-profiler-python

## Overview
This crate wraps `drasi-reaction-profiler` (at `../../../components/reactions/profiler`) as a PyO3 Python module (`drasi_reaction_profiler`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-profiler`
- **Path**: `../../../components/reactions/profiler`
- **Cargo dependency key**: `drasi-reaction-profiler`
