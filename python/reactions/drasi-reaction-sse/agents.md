# agents.md — drasi-reaction-sse-python

## Overview
This crate wraps `drasi-reaction-sse` (at `../../../components/reactions/sse`) as a PyO3 Python module (`drasi_reaction_sse`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-sse`
- **Path**: `../../../components/reactions/sse`
- **Cargo dependency key**: `drasi-reaction-sse`
