# agents.md — drasi-reaction-storedproc-mysql-python

## Overview
This crate wraps `drasi-reaction-storedproc-mysql` (at `../../../components/reactions/storedproc-mysql`) as a PyO3 Python module (`drasi_reaction_storedproc_mysql`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-storedproc-mysql`
- **Path**: `../../../components/reactions/storedproc-mysql`
- **Cargo dependency key**: `drasi-reaction-storedproc-mysql`
