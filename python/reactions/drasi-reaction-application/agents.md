# agents.md — drasi-reaction-application-python

## Overview
This crate wraps `drasi-reaction-application` (at `../../../components/reactions/application`) as a PyO3 Python module (`drasi_reaction_application`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-application`
- **Path**: `../../../components/reactions/application`
- **Cargo dependency key**: `drasi-reaction-application`
