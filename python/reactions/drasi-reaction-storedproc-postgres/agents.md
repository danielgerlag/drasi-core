# agents.md — drasi-reaction-storedproc-postgres-python

## Overview
This crate wraps `drasi-reaction-storedproc-postgres` (at `../../../components/reactions/storedproc-postgres`) as a PyO3 Python module (`drasi_reaction_storedproc_postgres`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-storedproc-postgres`
- **Path**: `../../../components/reactions/storedproc-postgres`
- **Cargo dependency key**: `drasi-reaction-storedproc-postgres`
