# agents.md — drasi-reaction-storedproc-mssql-python

## Overview
This crate wraps `drasi-reaction-storedproc-mssql` (at `../../../components/reactions/storedproc-mssql`) as a PyO3 Python module (`drasi_reaction_storedproc_mssql`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-storedproc-mssql`
- **Path**: `../../../components/reactions/storedproc-mssql`
- **Cargo dependency key**: `drasi-reaction-storedproc-mssql`
