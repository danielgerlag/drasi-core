# agents.md — drasi-reaction-log-python

## Overview
This crate wraps `drasi-reaction-log` (at `../../../components/reactions/log`) as a PyO3 Python module (`drasi_reaction_log`).

## Wrapped Rust Crate
- **Crate**: `drasi-reaction-log`
- **Path**: `../../../components/reactions/log`
- **Cargo dependency key**: `drasi-reaction-log`
